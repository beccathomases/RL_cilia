...
for t = 1:500
    ...
    if ~isempty(first_index)
        ...
        % plots left column as x and right column as y
        xlabel('\phi_1');
        ylabel('\phi_2');
        title('Stroke plot');
        grid on;
        ...
        % x = step within cycle, y = reward after each transition
...
fout = sprintf('cycle4_run_%d_g%1.2f_eps0%1.2f_alp0%1.2f_nEpisode%d.mat',seeds,gamma,epsilon0,alpha0,nEpisodes);
