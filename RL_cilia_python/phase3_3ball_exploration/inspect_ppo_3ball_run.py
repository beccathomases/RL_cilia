...
# User settings
# ------------------------------------------------------------
RESULT_FILE = "ppo_3ball_runs/results/ppo_3ball_steps1000000_seed2.npy"
OUTDIR = "figures_ppo_3ball_single_run"
TMAX = 100
...
if len(cycles) == 0:
    raise ValueError("No cycles found in saved PPO result.")
...
plt.xlabel("t")
plt.ylabel("angle")
plt.title(f"PPO 3-ball cycle: repeated angle traces to t={TMAX}")
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(OUTDIR, "ppo_3ball_cycle_angle_traces.png"), dpi=200, bbox_inches="tight")
...
plt.xlabel("x")
plt.ylabel("z")
plt.title("PPO 3-ball cycle: physical stroke overlay")
plt.axis("equal")
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(OUTDIR, "ppo_3ball_cycle_stroke_overlay.png"), dpi=200, bbox_inches="tight")
...
fig.suptitle("PPO 3-ball cycle: pairwise phase projections", fontsize=14)
fig.tight_layout(rect=[0, 0, 1, 0.95])
fig.savefig(os.path.join(OUTDIR, "ppo_3ball_cycle_phase_projections.png"), dpi=200, bbox_inches="tight")
...
plt.title("PPO 3-ball cycle: flux reward trace")
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(OUTDIR, "ppo_3ball_cycle_reward_trace.png"), dpi=200, bbox_inches="tight")
...
plt.xlabel("t")
plt.ylabel("flux reward")
plt.title(f"PPO 3-ball cycle: repeated flux reward to t={TMAX}")
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(OUTDIR, "ppo_3ball_cycle_reward_trace_repeated.png"), dpi=200, bbox_inches="tight")

print("\nSaved figures:")
print(" ", os.path.join(OUTDIR, "ppo_3ball_cycle_angle_traces.png"))
print(" ", os.path.join(OUTDIR, "ppo_3ball_cycle_stroke_overlay.png"))
print(" ", os.path.join(OUTDIR, "ppo_3ball_cycle_phase_projections.png"))
print(" ", os.path.join(OUTDIR, "ppo_3ball_cycle_reward_trace.png"))
print(" ", os.path.join(OUTDIR, "ppo_3ball_cycle_reward_trace_repeated.png"))
