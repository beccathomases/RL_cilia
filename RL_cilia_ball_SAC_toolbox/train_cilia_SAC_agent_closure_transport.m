...
%   - gated closure shaping
%   - gated transport shaping
...
seed = seedin;   % <-- change this for each run
rng(seed,"twister");
...
trainOpts = rlTrainingOptions( ...
    MaxEpisodes=onlineEpisodes, ...
    MaxStepsPerEpisode=opts.maxSteps, ...
    Verbose=true, ...
    Plots="none", ...
    StopTrainingCriteria="EpisodeCount", ...
    StopTrainingValue=onlineEpisodes);

fprintf('\nStarting online SAC training...\n');
